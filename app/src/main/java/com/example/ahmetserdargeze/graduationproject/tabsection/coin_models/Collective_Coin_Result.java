...
public class Collective_Coin_Result {
    @SerializedName("high")
    @Expose
    public String high;
    @SerializedName("last")
    ...
    public Collective_Coin_Result() {
    }

    public Collective_Coin_Result(String high, String last, String time, String baseVolume, String kurIdKurName, String low, String koinIdKoinName, String change, String volume) {
        this.high = high;
        this.last = last;
        this.time = time;
